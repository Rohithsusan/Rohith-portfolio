...
function Showcase() {
  ...
  return (
    <section className="py-20 px-8 xl:px-12 border-t border-gray-800 bg-black">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 xl:gap-6 h-[400px] xl:h-[600px] px-8 xl:px-12">
